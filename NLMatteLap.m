function [L] = NLMatteLap(I,A,epsilon,winRad,hoodSize) %NLMatteLap(I,A,epsilon,winRad,hoodSize)
...
%         win_inds=indsM(i-winRad:i+winRad,j-winRad:j+winRad);
%         win_inds=win_inds(:);
%         
%         winI=I(i-winRad:i+winRad,j-winRad:j+winRad,:);
